"""Iceberg / Delta loaders that turn lakehouse tables into datapilot inputs.
...
They each return a polars DataFrame, which any datapilot engine can
...
def load_iceberg_duckdb(
    ...
    *,
    ...
    Requires:
        ``pip install data-pilot-checker[duckdb,iceberg]``.
    """
    import duckdb
