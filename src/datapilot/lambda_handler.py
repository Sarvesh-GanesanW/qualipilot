...
.. code-block:: json

    {
      ...
      "config": { ...optional inline DatapilotConfig... }
    }
...
configure_logging(
    level=os.environ.get("DATAPILOT_LOG_LEVEL", "INFO"),
    json_logs=True,
)
...
def handler(event: dict[str, Any], context: Any) -> dict[str, Any]:
    ...
    cfg = DatapilotConfig(**event.get("config", {}))
...
# allow `python -m datapilot.lambda_handler` for quick local smoke tests
